                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" id="nameInput" name="nama" class="form-control form-control-fi" value="{{ old('nama', $fasilita->nama) }}" required placeholder="Contoh: WiFi, AC, Kolam Renang">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group mb-3 shadow-sm" style="border-radius: var(--fi-radius); overflow: hidden;">
                                ...
                                <input type="text" id="iconInput" name="ikon" class="form-control form-control-fi border-0 ps-2" value="{{ old('ikon', $fasilita->ikon) }}" placeholder="Contoh: bi-wifi">
                            </div>
                            ...
                            <div class="mt-3 p-3 border rounded-3 bg-white shadow-sm">
                                ...
                                <div class="d-flex align-items-center gap-2 text-dark">
                                    <i id="iconPreview" class="bi {{ old('ikon', $fasilita->ikon) }} fs-5 text-secondary"></i>
                                    <span id="namePreview" class="fw-medium">{{ old('nama', $fasilita->nama) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
